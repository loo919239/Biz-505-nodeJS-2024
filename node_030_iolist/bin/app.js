...
// session 를 사용하기 위한 설정
// cookiparser() 이후에 설치
app.use(
  session({
    key: "loo919239", // 식별자, 브라우저에 저장될 cookie 이름
    secret: "loo919239@naver.com", // SessionID 암호화용 키
    cookie: {
      httpOnly: true,
 ...
 * 모든 요청에 대한 공통으로 어떤 명령을 실행하고 싶을때
 * 사용하는 router 이다
 * 이 router 코드의 끝에는 반드시 next() 함수를 실행해 주어야 한다
 * 그렇지 않으면 다른 router 들이 전혀 실행 되지 않는다.
 *
 */

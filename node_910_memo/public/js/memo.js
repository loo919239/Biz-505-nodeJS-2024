document.addEventListener("DOMContentLoaded", () => {
  ...
  3. memo 가 포함된 target 을 알게되면 
    ...
    3-2. 만약 classList 에 list 가 포함되어 있다면 target 은 LI tag 이다

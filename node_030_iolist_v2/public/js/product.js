document.addEventListener("DOMContentLoaded", () => {
   ...
   * 하지만 detail, insert 드으이 화면에서는 해당 선택자는 없는 상태이다
   ...
   * 이때 사용하는 기호가 "객체?" dlek. 이러한 코드를 null safe 코드 라고 한다
   */
  ...
  // DOMContentLoaded evemt 가 실행될때 마다 실행
  // 화면이 새로고침 될떄마다 실행

...
// import fs from "fs"
// fs.existsSync()
// fs 모듈에서 existSync() 함수와 mkdirSync() 함수만 사용하겠다
...
// ~/Document/workspace/nodejs/node_030_iolist
const aqqRoot = process.env.PWD;
// ~/Document/workspace/nodejs/node_030_iolist/public/uploads
const upLoadPath = path.join(aqqRoot, "public", "uploads");
